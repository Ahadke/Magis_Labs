export const PRICING_FAQS = [
  ...
  },
  {
    ...
    a: "Branding and identity, UI/UX and website design, launch and explainer videos, social and content strategy, growth marketing, healthcare SEO, local SEO, AEO and GEO, AI automation, CRM workflows, drone production, and strategic consulting.",
  },
  {
    q: "How do you help healthcare businesses attract patients and grow?",
    a: "We combine search visibility, content, paid media, conversion-focused websites, and consistent creative to help clinics and care organizations get found, earn trust, and turn interest into appointments or inquiries.",
  },
  {
  ...
  },
  {
    ...
    a: "Complex care and technology are hard to explain quickly. Clear brand identity and well-made video help patients, families, and buyers understand what you do, trust what they see, and take the next step with confidence.",
  },
  {
    q: "How much does healthcare marketing cost, and how long do projects take?",
    a: "Cost depends on scope, services, and goals. Individual creative projects often run several weeks; branding, websites, automation, and ongoing growth engagements typically take longer. Every engagement starts with defined scope, timeline, and deliverables.",
  },
  {
  ...
  },
  {
    ...
    a: "Book a discovery call. We'll learn about your business, goals, and challenges, then recommend the services and strategy that fit best.",
  },
] as const;
